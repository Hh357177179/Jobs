...
Page({
    ...
    getCode: function() {
        ...
        a.data.userPhone.match(/^(13[0-9]|14[579]|15[0-3,5-9]|16[6]|17[0135678]|18[0-9]|19[89])\d{8}$/) ? wx.request({
            ...
            success: function(e) {
                if (console.log(e), 200 == e.data.code) var o = 60, t = setInterval(function() {
                    a.setData({
                        codeMsg: o + "s",
                        codeBtn: !0
    ...
    phoneClick: function() {
        var a = this;
        "" == a.data.userName ? e.showMsg("姓名不能为空!") : "" == a.data.userPhone ? e.showMsg("电话号码不能为空!") : "" == a.data.code ? e.showMsg("验证码不能为空!") : wx.request({
